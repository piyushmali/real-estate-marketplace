...
// Create a context to track if List Property button exists on the page
export const ListPropertyButtonContext = createContext<{
  hasPageButton: boolean;
  setHasPageButton: (value: boolean) => void;
}>({
  hasPageButton: false,
  setHasPageButton: () => {},
});
...
export const useListPropertyButton = () => useContext(ListPropertyButtonContext);
...
export default function Layout({ children }: LayoutProps) {
  ...
  const [hasPageButton, setHasPageButton] = useState(false);
  ...
  return (
    <ListPropertyButtonContext.Provider value={{ hasPageButton, setHasPageButton }}>
              ...
              <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
                <div>
                  ...
                  <ul className="mt-4 space-y-2">
                    ...
                    <li><Link href="/list-property"><span className="text-sm text-neutral-500 hover:text-neutral-700 cursor-pointer">List a Property</span></Link></li>
    ...
    </ListPropertyButtonContext.Provider>
  );
}
